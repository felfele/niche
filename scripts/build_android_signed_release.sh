...
unsigned_apk_name='app-release.apk'
signed_apk_name='app-release-signed.apk'
debug_signed_apk_name='debug-signed.apk'
target_apk_name='niche-play-store-release.apk'
